...
@interface firstViewController ()<UITableViewDataSource, UITableViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource,UITextFieldDelegate>{
...
- (void)loadTitleTableView {
    _titleTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 30, kAverageTableViewWidth, kScreenHeight-kTopCarIconListViewHeight) style:UITableViewStylePlain];
...
- (void)loadDetailView {
    ...
    _detailTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, kAverageTableViewWidth*7, kScreenHeight) style:UITableViewStylePlain];
